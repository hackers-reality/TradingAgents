...
class ResearchPlan(BaseModel):
    ...
    recommendation: PortfolioRating = Field(
        description=(
            ...
            "Hold / Underweight / Sell. Commit to the side with the clearly "
            "stronger arguments; reserve Hold for a flat no-edge read with "
            "an explicit prior position. Do not pick a direction merely to "
            "be decisive."
        ),
    )
    rationale: str = Field(
...
class PortfolioDecision(BaseModel):
    ...
    rating: PortfolioRating = Field(
        description=(
            ...
            "Underweight / Sell, picked based on the analysts' debate. Commit "
            "to the side with the clearly stronger arguments; reserve Hold "
            "for a flat no-edge read with an explicit prior position, rather "
            "than forcing a direction to appear decisive."
        ),
    )
